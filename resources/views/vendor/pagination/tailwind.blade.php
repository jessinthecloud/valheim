@if ($paginator->hasPages())
    <nav role="navigation" aria-label="{{ __('Pagination Navigation') }}" class="flex items-center justify-center w-full mb-6">
        ...
        <div class="hidden justify-center items-center flex-wrap sm:flex-1 sm:flex lg:flex-nowrap">
            <div class="lg:mr-8">

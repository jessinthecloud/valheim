<nav class="w-full justify-center bg-amber-900 py-4 mt-0 
    ...
    <div class="nav-container max-w-6xl mx-auto flex flex-wrap justify-center items-center lg:justify-between">
        ...
        ">
            ...
            <li>
                <a href="{{ route('about') }}" class="block hover:bg-gray-800 hover:text-gray-100 px-3 py-3 flex items-center transition ease-in-out duration-150">
                    About
                </a>
            </li>
            {{--<li>
            ...
            <li>
                ...
                >
                    <svg class="w-4" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>GitHub icon</title><path 
